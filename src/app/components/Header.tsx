...
export default function Header() {
 ...
 const handleLogout = async () => {
    ...
    startTransition(() => {
      router.replace('/login'); // replace evita volver atrás al presionar “Atrás”
    });
  };
        ...
        {user ? (
          <>
            ...
            <button
              ...
              disabled={isPending}
              className="btn-click-effect flex items-center gap-2 rounded-full bg-red-500/10 px-4 py-2 text-sm font-medium text-red-500 hover:bg-red-500/20 dark:bg-red-500/20 dark:hover:bg-red-500/30"
            >
          ...
          <button
            ...
            className="btn-click-effect flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2 text-sm font-medium text-primary hover:bg-primary/20 dark:bg-primary/20 dark:hover:bg-primary/30"
          >
            <span className="material-symbols-outlined text-base">
